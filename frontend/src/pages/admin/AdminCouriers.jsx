...
const AdminCouriers = () => {
  ...
  const handleDelete = async (id) => {
    ...
    const courierName = courier ? courier.name : 'this courier service';
    const confirmed = await confirmDelete(`Enter your administrator password to permanently delete the courier service "${courierName}".`);
    if (!confirmed) return;
    try {
